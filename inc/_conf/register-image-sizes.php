 ...
 */
function agt_human_image_size_to_wp_sizes($human_size) {
  ...
  switch ($human_size) {
    ...
    default:
      if (function_exists('aucor_core_debug_msg')) {
        aucor_core_debug_msg('Image size error - Missing human readable size {' . $human_size . '}', array('agt_get_image'));
      }
  }
 ...
 */
function agt_content_width() {

  $GLOBALS['content_width'] = 720;

}
add_action('after_setup_theme', 'agt_content_width', 0);
