 ...
 */
function agt_dropdown_icon_to_menu_links($item_output, $item, $depth, $args) {
...
add_filter('walker_nav_menu_start_el', 'agt_dropdown_icon_to_menu_links', 10, 4);
 ...
 * @return string menu item with possible description
 */
function agt_social_menu_icons($title, $item, $args, $depth) {
...
add_filter('nav_menu_item_title', 'agt_social_menu_icons', 10, 4);
 ...
 * @return string menu item with possible description
 */
function agt_icons_from_classes($title, $item, $args, $depth) {
...
add_filter('nav_menu_item_title', 'agt_icons_from_classes', 10, 4);
